  ...
  return (
    ...
    >
      <StackColumn>
        ...
        <FooterLink 
        text={'9th St, New York, NY 10011, USA'} 
        />
        <FooterLink 
        text={'47 999-345-34567'} 
        />
        <FooterLink 
        text={'info@thehometownsales.com'} 
        />
      </StackColumn>
      ...
      <StackColumn>
        <FooterTitle text={'The Hometown Sales'} />
        <Stack 
        direction='row' 
        width= '70px'
        maxWidth='100%'
        ...
        component='p' 
        >
          &copy; 2024 Thw Homwtown Sales Inc.
        </Typography>
      </StackColumn>
    </BoxRow>
  )
